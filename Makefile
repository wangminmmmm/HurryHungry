#############################################################################
# Makefile for building: ChickenOutbreak
# Generated by qmake (3.1) (Qt 5.15.4)
# Project:  ChickenOutbreak.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile ChickenOutbreak.pro -spec linux-g++ CONFIG+=debug
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = ChickenOutbreak1.0.0
DISTDIR = /root/open_project/HurryHungry/ChickenOutbreak/.tmp/ChickenOutbreak1.0.0
LINK          = g++
LFLAGS        = -fPIC
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		ChickenOutbreak.pro  main.cpp
QMAKE_TARGET  = ChickenOutbreak
DESTDIR       = 
TARGET        = ChickenOutbreak


first: all
####### Build rules

ChickenOutbreak:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: ChickenOutbreak.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		ChickenOutbreak.pro
	$(QMAKE) -o Makefile ChickenOutbreak.pro -spec linux-g++ CONFIG+=debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents qml/translations/en_EN.ts qml/translations/de_DE.ts qml/translations/de_AT.ts $(DISTDIR)/
